        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="#producto" className="hover:text-cyan-400 transition-colors">Características</a></li>
              <li><a href="#como-funciona" className="hover:text-cyan-400 transition-colors">Cómo Funciona</a></li>
              <li><a href="#suscripcion" className="hover:text-cyan-400 transition-colors">Precios</a></li>
              <li><a href="#demo" className="hover:text-cyan-400 transition-colors">Demo en Vivo</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#equipo" className="hover:text-cyan-400 transition-colors">Equipo Médico</a></li>
              <li><a href="#blog" className="hover:text-cyan-400 transition-colors">Blog</a></li>
              <li><a href="#carreras" className="hover:text-cyan-400 transition-colors">Carreras</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#privacidad" className="flex items-center gap-2 hover:text-cyan-400 transition-colors">
                  <Shield className="w-4 h-4" />
                  Política de Privacidad
                </a>
              </li>
              <li>
                <a href="#terminos" className="flex items-center gap-2 hover:text-cyan-400 transition-colors">
                  <FileText className="w-4 h-4" />
                  Términos de Uso
                </a>
              </li>
              <li>
                <a href="#hipaa" className="flex items-center gap-2 hover:text-cyan-400 transition-colors">
                  <Shield className="w-4 h-4" />
                  Cumplimiento HIPAA
                </a>
              </li>
              <li>
                <a href="mailto:info@retiscan.app" className="flex items-center gap-2 hover:text-cyan-400 transition-colors">
