...
export function ContactForm() {
    ...
    return (
        <section
            id="contacto"
            className="relative py-24 overflow-hidden border-t border-white/10 noise-overlay animated-gradient text-white"
            style={{
        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div ref={leftContent.ref} style={leftContent.style} className="space-y-10">
                        <div>
                            <div className="inline-block px-4 py-2 bg-white/10 border border-white/20 rounded-full backdrop-blur-sm mb-6">
                                <span className="text-sm font-semibold text-white">CONTÁCTANOS</span>
                            </div>
                            <SplitText as="h2" className="text-4xl lg:text-5xl font-bold text-white mb-6 text-balance" baseDelay={200}>
